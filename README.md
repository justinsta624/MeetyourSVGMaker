# Object-oriented Programming: SVG Logo Maker
  ...
  ![Installation](https://img.shields.io/badge/Installation-npm/Inquirer-red)
...
[README.md: A project repository generated using application](https://github.com/justinsta624/MeetyourSVGMaker/blob/main/logo.svg)
</br>
...
* To build a Node.js command-line application that takes in user input to generate a logo and save it as an [SVG file](https://en.wikipedia.org/wiki/Scalable_Vector_Graphics).
...
* To provide a link to a walkthrough video that demonstrates its functionality and passes all of the tests. [Video Submission Guide](https://coding-boot-camp.github.io/full-stack/computer-literacy/video-submission-guide)
* a mock-up of the generated SVG given the following input entered by the user ![Image showing a green circle with white text that reads "SVG.".](./Images/10-oop-homework-demo.png)
